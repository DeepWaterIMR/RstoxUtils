...
##' @param proj.out the \code{\link[sp]{proj4string}} projection the coordinates should be transformed to. Defaults to \code{proj.og} and no transformation will be made.
...
transformCoord <- function(x = NULL, lon = NULL, lat = NULL, new.names = c("lon.utm", "lat.utm"), proj.og = "+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0", proj.out = "+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0", verbose = FALSE, bind = FALSE, na = "ignore") {
